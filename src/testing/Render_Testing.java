...
public class Render_Testing {
    ...
    public void basicRenderTwoColorTest() {
        ...
        scene.addGeometries(
                new Triangle(new Point3D(150, 50, 100), new Point3D(50, 150, 100), new Point3D(150, 150, 100)),
    ...
    public void basicRenderMultiColorTest() {
        ...
        ImageWriter imageWriter = new ImageWriter("color render test T", 500, 500, 500, 500);
        Render render = new Render(imageWriter, scene).setMultithreading(3).setDebugPrint();
